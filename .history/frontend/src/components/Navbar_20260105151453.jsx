...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      <div className="bg-black text-[#d4af37] text-xs px-6 h-12">
        <div className="max-w-[1370px] h-full mx-auto flex items-center justify-between">
          {/* LEFT — PHONE + EMAIL */}
        ...
        <div className="max-w-[1370px] mx-auto h-24 flex items-center justify-between px-8">
          ...
          <div className="hidden lg:flex items-center gap-4">
            <ul className="flex items-center gap-4 text-gray-700 text-base font-medium">
              ...
              <li
                className={`${activeNav === "Media" ? "text-[#d4af37]" : ""}`}
              >
                <Link to="/media">Media</Link>
              </li>

              <li
                className={`${activeNav === "Venture" ? "text-[#d4af37]" : ""}`}
              >
                <Link to="/join-venture">Join Venture</Link>
              </li>

              <li
                className={`${activeNav === "contact" ? "text-[#d4af37]" : ""}`}
              >
