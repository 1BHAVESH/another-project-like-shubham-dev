    ...
    >
      ...
      <div className="relative z-10 max-w-[1300px] mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 px-6">
        ...
        <div className="flex items-center space-x-2 text-white">
          ...
          <div>
            <h2 className="text-xl font-bold text-white leading-none">{states.awards}</h2>
            <p className="text-sm text-white mt-1">Award Winning</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4 text-white">
          ...
          <div>
            <h2 className="text-xl font-bold text-white leading-none">{states.projects}</h2>
            <p className="text-sm text-white mt-1 font-light">Projects Ready</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4 text-white">
          ...
          <div>
            <h2 className="text-xl font-bold text-white leading-none">{states.clients}</h2>
            <p className="text-sm text-white mt-1">Happy Client</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4 text-white">
          ...
          <div>
            <h2 className="text-xl font-bold text-white leading-none">{states.team}</h2>
            <p className="text-sm text-white mt-1 ">Team Members</p>
          </div>
        </div>
